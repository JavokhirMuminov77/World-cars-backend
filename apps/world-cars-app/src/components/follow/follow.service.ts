...
export class FollowService {
	...
	public async subscribe(followerId: ObjectId, followingId: ObjectId): Promise<Follower> {
		...
		const result = await this.registerSubcription(followerId, followingId);
	...
	private async registerSubcription(followerId: ObjectId, followingId: ObjectId): Promise<Follower> {
		try {
