...
import { Member } from 'apps/world-cars-app/src/libs/dto/member/member';
import { Property } from 'apps/world-cars-app/src/libs/dto/property/property';
import { MemberStatus, MemberType } from 'apps/world-cars-app/src/libs/enums/member.enum';
import { PropertyStatus } from 'apps/world-cars-app/src/libs/enums/property.enum';
...
export class BatchService {
  ...
  public getHello(): string {
    return 'Welcome to World-cars BATCH Server!';
  }
}
